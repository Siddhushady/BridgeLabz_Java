...
/**
 * FactorsFor class finds and displays all factors of a given number using a for loop.
 ...
 * This demonstrates the use of for loops for iterative factor checking.
 */
public class FactorsFor {
    public static void main(String[] args) {
        ...
        if (number > 0) {
            // For loop to check all numbers from 1 to (number-1)
